...
[Click to view project website](https://folarin-ogungbemi.github.io/Portfolio-Project-1/ "link to live website")

# [GOSIP](https://folarin-ogungbemi.github.io/Portfolio-Project-1/ "link to live website")

## Preview

![Website Mock-up](assets/images/Mock-up%20GOSIP.png "A pictographic display of the website on different devices")
 ...
 * [x] The main page of the website will contain important informations helpful for users knowledge about the website. The images and words used will describe what the website is about, News highlights, the goal of the website, and the members of the organiztion.
 ...
 * [x] The website will inform the user of the use of their data informations. This information will be readable at the signing up page.
...
1. Are your registered with gitpod by now?
    ...
    1. If yes ?
        * Navigate to the green button ["Clipboard"](https://folarin-ogungbemi.github.io/Portfolio-Project-1/ "click on this link to view clipboard") and click on it.
...
## Code
* The turorial from [Code Institute](https://learn.codeinstitute.net/ci_program/diplomainfullstacksoftwarecommoncurriculum "Visit Code Institute") was the most helpful link in writing the codes of this website.
